...
export default function MenProduct() {
    ...
    return (
        <div className='container rounded-5 p-4' style={{ background: 'linear-gradient(145deg,rgb(230, 235, 237),rgb(246, 247, 248))' }}>
            <ToastContainer/>
            <div className='row'>
                {/* <h3 className='text-start fw-semibold '>Men Product</h3> */}
                {
                    fdata && fdata.map((v) => (
